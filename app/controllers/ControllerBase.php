...
class ControllerBase extends Controller
{
    ...
    protected function beforeExecuteRoute( $dispatcher ) 
    {
        ...
        $this->assets
                ...
                ->addJs('js/jquery.lazyload.min.js', true)
                ->addJs('js/jquery.dataTables.min.js', true)
                ->addJs('js/jquery.fancybox.pack.js', true)
                ->addJs('js/jquery.fancybox-thumbs.js', true)
